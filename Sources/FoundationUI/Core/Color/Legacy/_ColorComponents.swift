...
//}
//
//internal extension FoundationUIColorComponents {
//    func hex() -> String {
//        [
//            red.toHexValue(),
//            green.toHexValue(),
...
//}
//
//public extension FoundationUIColorComponents {
//    func swatch(_ mode: SwatchColorModel? = nil) -> some View {
//        HStack {
//            FoundationUI.Shape.roundedSquare(.regular, size: .regular.offset(.half.down))
...
//        let colorSet = FoundationUI.ColorSet.primary
//        VStack(alignment: .leading) {
