...
public extension TrussUI {
    struct ColorComponents {
        ...
        /// `TrussUI.ColorComponents(hue360: 3, saturation: 81, brightness: 100)`
...
extension TrussUI.ColorComponents: ShapeStyle {
...
public extension TrussUI.ColorComponents {
    ...
    init(color: Color, colorScheme: TrussUI.ColorScheme) {
...
extension TrussUI.ColorComponents: Equatable, Sendable, Hashable {}

extension TrussUI.ColorComponents: CustomDebugStringConvertible {
