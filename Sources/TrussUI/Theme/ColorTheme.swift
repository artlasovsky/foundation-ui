...
public extension Color {
    typealias truss = TrussUI.DynamicColor
}
...
public protocol DynamicColorDefaults {
    typealias VariationKeyPath = KeyPath<TrussUI.DynamicColor, TrussUI.DynamicColor>
    func makeVariation(
        light: TrussUI.DynamicColor.Adjustment,
        dark: TrussUI.DynamicColor.Adjustment,
        lightAccessible: TrussUI.DynamicColor.Adjustment?,
        darkAccessible: TrussUI.DynamicColor.Adjustment?
    ) -> Self
}

extension TrussUI.DynamicColor: DynamicColorDefaults {}

/// Tint are static extensions of `DynamicColor`
public extension DynamicColorDefaults where Self == TrussUI.DynamicColor {
...
internal extension DynamicColorDefaults where Self == TrussUI.DynamicColor {
    static var red: Self {
        .init(
